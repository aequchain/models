...
```mermaid
graph TD
    A[PROTOTYPE: 1-5 People] -->|Validation| B[MICRO: 5-20 People]
    B -->|Replication| C[SMALL: 20-50 People]
    C -->|Network| D[MEDIUM: 50-180 People]
    D -->|Expansion| E[LARGE: 180-500 People]
    E -->|Federation| F[REGIONAL: 500-2000 People]
    F -->|Global Network| G[PLANETARY: 2000+ Nodes]
...
```mermaid
graph LR
    A[Main Entrance & Admin] --> B[CVD Diamond Facility]
    A --> C[Mycelium Cultivation]
    A --> D[Hempcrete Processing]
    A --> E[Bamboo Processing]
    A --> F[Bio-Plastics Lab]
    A --> G[R&D Center]
    A --> H[Employee Village]
    ...
    I --> J[Warehouse & Distribution]
    
    K[Renewable Energy Hub] --> B
    K --> C
    K --> D
    K --> E
    K --> F
...
```mermaid
sequenceDiagram
    participant E as External Customer
    participant E2 as Enterprise 2
    participant T as Treasury
    participant M as All Members
    participant E1 as Enterprise 1 (Internal)
    
    E->>E2: Purchase Diamond Tools ($10,000)
    E2->>T: Add Revenue (+$10,000)
    T->>M: Rebalance (Each member +$55.56)
    
    E1->>E2: Request Mycelium Substrates
    E2->>E1: Transfer Materials (Zero Cost)
    Note over E2,E1: Internal transaction<br/>No treasury change<br/>Contribution tracked
```
...
```mermaid
graph TD
    E1[Enterprise 1: Vertical Farms] -->|Agricultural Waste| E2[Enterprise 2: Materials]
    E1 -->|Hemp Cultivation| E2
    E1 -->|Employee Nutrition| E2
    
    E2 -->|Diamond LED Components| E1
    E2 -->|Mycelium Substrates| E1
    E2 -->|Diamond Tools| E1
    E2 -->|Structural Materials| E1
    
    E5[Enterprise 5: Phyto-Sterile] -->|Biochar| E2
    E5 -->|Carbon Feedstock| E2
    E5 -->|Allelopathic Extracts| E2
    
    E2 -->|Diamond Electrodes| E5
    E2 -->|Composite Materials| E5
    
    E8[Enterprise 8: Machinery] -->|Wood Waste| E2
    E8 -->|Equipment Maintenance| E2
    
    E2 -->|Diamond Cutting Tools| E8
    E2 -->|Composite Materials| E8
    E2 -->|Wear-Resistant Coatings| E8
    
    E4[Enterprise 4: Distribution] -->|Logistics| E2
    E4 -->|Waste Collection| E2
    
    E2 -->|Packaging Materials| E4
    E2 -->|Vehicle Components| E4
    
    E3[Enterprise 3: Nursery] <-->|Structural Materials, Tools| E2
    E6[Enterprise 6: Community Farms] <-->|Materials, Tools| E2
    E7[Enterprise 7: Open Studio] <-->|Advanced Materials, Tools| E2
    E9[Enterprise 9: Housing] <-->|Building Materials, Finishes| E2
    E10[Enterprise 10: Tools] <-->|Diamond Coatings, Composites| E2
    E11[Enterprise 11: Diamond] <-->|Carbon Feedstock, Technology| E2
```
...
```mermaid
graph TD
    A[Tier 1: Operational<br/>Day-to-day decisions<br/>Simple majority 50%+1] --> B[All Enterprise 2 Employees]
    
    C[Tier 2: Strategic<br/>Long-term planning<br/>Supermajority 66%] --> B
    
    D[Tier 3: Cross-Enterprise<br/>Inter-enterprise collaboration<br/>Consensus 75%] --> E[E2 Coordinators + Representatives]
    
    F[Tier 4: Network<br/>EVER-wide policies<br/>Supermajority 80%] --> G[All EVER Network Members]
    
    B --> H[Liquid Delegation<br/>Expertise-based proxy voting]
    E --> H
    G --> H
```
